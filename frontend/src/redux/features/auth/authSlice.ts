...
import type { AuthState, LoginPayload, LoginResponse, RegisterPayload, RegisterResponse, ResendForgotPasswordOtpPayload, ResendForgotPasswordOtpResponse, ResetPasswordPayload, User, VerifyForgotPasswordPayload, VerifyForgotPasswordResponse, VerifyOtpPayload, VerifyOtpResponse } from "../../../types/user";
...
>(
    ...
    async (data, { rejectWithValue }) => {
        try {
            const response = await api.post(API_ROUTES.AUTH.RESEND_FORGOT_PASSWORD_OTP, data);
