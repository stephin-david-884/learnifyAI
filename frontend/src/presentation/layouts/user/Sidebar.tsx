...
import { LayoutDashboard, FileText, User, LogOut, BrainCircuit, BookOpen, X, Crown, CreditCard, ClipboardList, Mic } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const navLinks = [
    ...
    { to: '/subscription/payments', icon: CreditCard, text: 'Payments' }
  ];
  return (
    <>
